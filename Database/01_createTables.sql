...
/* =============================================================================
   HỆ THỐNG CƠ SỞ DỮ LIỆU TMĐT TOÀN DIỆN: 26 BẢNG
   ============================================================================= */
...
CREATE TABLE APP_USER (
    ...
    BIRTH        DATE,
    GENDER       VARCHAR2(10) CHECK (GIOI_TINH IN ('Nam', 'Nu')),
    USER_TYPE    VARCHAR2(20) DEFAULT 'CUSTOMER' CHECK (USER_TYPE IN ('ADMIN', 'STAFF', 'CUSTOMER', 'AFFILIATE')),
...
CREATE TABLE ORDERS (
    ...
    USER_ID          NUMBER(10) NOT NULL,
    COUPON_ID        NUMBER, -- Liên kết bảng COUPON
    SUBTOTAL         NUMBER(18,2) DEFAULT 0 NOT NULL, -- Tổng tiền hàng (chưa giảm, chưa ship)
    DISCOUNT_AMOUNT  NUMBER(18,2) DEFAULT 0,          -- Số tiền thực tế được giảm
    SHIPPING_FEE     NUMBER(18,2) DEFAULT 0,          -- Phí vận chuyển
    TOTAL            NUMBER(18,2) DEFAULT 0 NOT NULL, -- Tiền khách trả cuối cùng
...
CREATE TABLE ORDER_DETAIL (
    ...
    PRICE           NUMBER(18,2) NOT NULL, -- Giá tại thời điểm mua
